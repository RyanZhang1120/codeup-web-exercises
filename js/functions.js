...
var percentage = prompt('What percentage do you give as tip?')
alert('The tip should be $'+ calculateTip(percentage, bill));
console.log(calculateTip(percentage, bill));
/**
 * TODO:
